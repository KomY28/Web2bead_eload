                ...
                <div class="p-6 text-gray-900">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <?php $__currentLoopData = $labdarugok; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jatekos): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo e($jatekos->vezeteknev); ?> <?php echo e($jatekos->utonev); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo e($jatekos->klub->csapatnev); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo e($jatekos->poszt->nev); ?>

                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <?php echo e($jatekos->ertek); ?>
...
<?php endif; ?><?php /**PATH D:\nb1app\resources\views/labdarugok/index.blade.php ENDPATH**/ ?>